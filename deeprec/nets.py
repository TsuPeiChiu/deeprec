...
#    keras.backend.clear_session()
    ...
    conv_major = Conv2D(filters=params.hbond_major['nb_filter'], 
                        ...
                        kernel_regularizer=regularizers.l1_l2(l1=params.hbond_major['l1'], 
    ...
    conv_minor = Conv2D(filters=params.hbond_minor['nb_filter'], 
                        ...
                        padding='valid',
                        data_format='channels_first',
                        kernel_regularizer=regularizers.l1_l2(l1=params.hbond_minor['l1'], 
    ...
    hidden = Dense(units=params.joint['nb_hidden'], 
                   ...
                   kernel_regularizer=regularizers.l1_l2(l1=params.joint['l1'], l2=params.joint['l2']))(merge)    
    dropout = Dropout(params.joint['drop_out'], noise_shape=None, seed=None)(hidden)
